...
- (void)viewDidLoad {
    ...
    _playView = [[LMVideoPlayerOperationView alloc] initWithFrame:CGRectMake(0, self.view.bounds.size.height / 5, self.view.frame.size.width, self.view.bounds.size.height / 3) videoURLString:@"http://vfx.mtime.cn/Video/2016/04/28/mp4/160428165224954898.mp4"];
    [_playView play];
