...
@implementation ChinaBoxTableViewCell
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        self.weekBox = [[UILabel alloc]init];
        self.totalBox = [[UILabel alloc]init];
        ...
        [self.back addSubview:self.weekBox];
        [self.back addSubview:self.totalBox];
...
-(void)layoutSubviews{
   ...
   // self.name.font = [UIFont fontWithName:@"Helvetica Neue" size:17];
    ...
    self.back.frame = CGRectMake(30, 130, UIScreenWidth - 50, 30);
    self.weekBox.frame = CGRectMake(0, 0, (UIScreenWidth - 50)/2, 30);
    self.weekBox.font = [UIFont systemFontOfSize:14];
    self.weekBox.backgroundColor = [[UIColor lightGrayColor] colorWithAlphaComponent:0.1];
    self.weekBox.textColor = [UIColor darkGrayColor];
    self.weekBox.textAlignment = NSTextAlignmentCenter;
    self.totalBox.frame = CGRectMake(UIScreenWidth/2 - 50/2, 0, UIScreenWidth/2 - 50/2, 30);
    self.totalBox.backgroundColor = [[UIColor lightGrayColor] colorWithAlphaComponent:0.1];
    self.totalBox.textAlignment = NSTextAlignmentCenter;
    self.totalBox.font = [UIFont systemFontOfSize:14];
    self.totalBox.textColor = [UIColor darkGrayColor];
